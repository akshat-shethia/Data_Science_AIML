...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "include directory": r"C:/miniconda/MINICONDA_WORKSPACE/pandas_section5/env/Library/include",
                "lib directory": r"C:/miniconda/MINICONDA_WORKSPACE/pandas_section5/env/Library/lib",
