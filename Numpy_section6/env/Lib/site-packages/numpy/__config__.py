...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "include directory": r"C:/miniconda/MINICONDA_WORKSPACE/Numpy_section6/env/Library/include",
                "lib directory": r"C:/miniconda/MINICONDA_WORKSPACE/Numpy_section6/env/Library/lib",
